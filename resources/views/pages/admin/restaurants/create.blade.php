            ...
            <div class="col-md-5">
                <form action="/admin/restaurants" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="location" class="form-control" placeholder="Enter location" id="location" value="{{old('location')}}"/>
                        @error('location')
                        <div class="alert alert-danger p-3 mt-2">
                            {{$message}}
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="time" name="open_in" class="form-control" id="open_in" value="{{old('open_in')}}"/>
                        @error('open_in')
                        <div class="alert alert-danger p-3 mt-2">
                            {{$message}}
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="time" name="close_in" class="form-control" id="close_in" value="{{old('close_in')}}"/>
                        @error('close_in')
                        <div class="alert alert-danger p-3 mt-2">
                            {{$message}}
                        </div>
